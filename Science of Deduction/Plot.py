# Title: Plots for Science of Deduction
...
def get_graph(name, part_one, part_two=None, part_three=None):
    ...
    try:
        ...
        coeff_one = gradient_descent(x, y, 1e-3, int(1e+6), coeff_one)
    except FileNotFoundError:
        coeff_one = gradient_descent(x, y, 1e-3, int(1e+6))
    ...
    if part_two is not None:
        ...
        try:
            ...
            coeff_two = gradient_descent(x, y, 5e-4, int(1e+6), coeff_two)
        except FileNotFoundError:
            coeff_two = gradient_descent(x, y, 5e-4, int(1e+6))
    ...
    if part_three is not None:
        ...
        try:
            ...
            coeff_three = gradient_descent(x, y, 1e-4, int(1e+6), coeff_three)
        except FileNotFoundError:
            coeff_three = gradient_descent(x, y, 1e-4, int(1e+6))
